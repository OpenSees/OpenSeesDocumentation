...
.. csv-table:: 
   ...
   $useshear, |integer|, "If nonzero, the contribution of the partial loading of the shear stresses is approximately taken into account. As explained in the relevant reference [4], this option creates problems when used in dynamic analyses (*default value=0*)"

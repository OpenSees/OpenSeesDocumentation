...
#. **uniaxial materials** which define a uniaxial (1 dimensional) stress-strain relationsship.

#. **nDimensional materials** which define multi-dimensional (plane stress, plane strain, or 3d) stress-strain relationships.

#. **sections** which define copuled moment-curvature and axial-deforation relationship for beam column elements.
